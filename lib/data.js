  ...
  */
  this.search = function (collection) {
    ...
    if (typeof collection === "undefined") {
      return makeReturnValue(this.StatusEnum.ERROR, "Collection name is required.");
    }
    ...
    rv.results = data[collection].slice();
    return rv;
  };

  this.create = function (collection, entry) {
    //TODO: Make some status codes and make this return a status code, or even a status object
    // so we can still return the _id in case we decide to aut-create it some day.
    var rv = {};
    var newEntry = {};
