//TODO: shouldn't this be Data.js rather than data.js? and Data.spec.js instead of data.spec.js?
...
function Data(options) {
  ...
  */
  ...
  this.write = function () {
    var that = this;
    collections.forEach(function (collection) {
      fs.writeFileSync(that.outputDir + "/" + collection + ".json", JSON.stringify(data[collection], null, 2));
    });
  };
}
