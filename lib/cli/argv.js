...
module.exports = function (argv) {
  ...
  //TODO: The whole check-message-then-check-status thing is awfully repetitive....should be a function.
  if (inputDir) {
  ...
  // TODO: Should replace all instances if __dirname + ".." with path.join?
